 ...
 */
public class PlaySessionJDBC_NoCon implements PlaySession {
     ...
     */
    public PlaySessionJDBC_NoCon(Date date, Player host, BoardGame game, int playTime, Collection<Player> players, Player winner) {
        this.date = date;
        this.host = host;
        this.game = game;
